...
class ilObjOpenCastAccess extends ilObjectPluginAccess
{
    ...
    public static function checkAction(
        ...
        switch ($cmd) {
            ...
            case self::ACTION_SCHEDULE_EVENT:
                return self::hasPermission(self::PERMISSION_SCHEDULE);
            case self::ACTION_RECORD_EVENT:
                return self::hasPermission(self::PERMISSION_RECORD);
            default:
                return false;
        }
    }
    ...
    public static function adjustPerms(int $ref_id, array $perms = []): void
    {
        $parent_obj = ilObjOpenCast::_getParentCourseOrGroup($ref_id);
